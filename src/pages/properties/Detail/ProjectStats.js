              ...
              <Row className="py-1">
                <Col xl={3} sm={6}>
                  <Media className="p-3">
                    ...
                    <Media body>
                      <h4 className="mt-0 mb-0">{project.totalTasks}</h4>
                ...
                <Col xl={3} sm={6}>
                  <Media className="p-3">
                    ...
                    <Media body>
                      <h4 className="mt-0 mb-0">{project.totalTasksCompleted}</h4>
                ...
                <Col xl={3} sm={6}>
                  <Media className="p-3">
                    ...
                    <Media body>
                      <h4 className="mt-0 mb-0">{project.totalMembers}</h4>
                ...
                <Col xl={3} sm={6}>
                  <Media className="p-3">
                    ...
                    <Media body>
                      <h4 className="mt-0 mb-0">{project.totalHoursSpent}</h4>
