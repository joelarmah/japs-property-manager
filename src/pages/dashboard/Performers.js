    ...
    return (
        <Card>
            <CardBody className="pb-0 pt-2">
                ...
                <Member image={avatarImg1} name="Joel A" description="Senior Sales Guy" />
                <Member image={avatarImg1} name="Greeva Y" description="Social Media Campaign" />
                <Member image={avatarImg1} name="Nik G" description="Inventory Manager" />
                <Member image={avatarImg1} name="Hardik G" description="Sales Person" />
                <Member image={avatarImg1} name="Stacy K" description="Sales Person" className="mb-3" />
