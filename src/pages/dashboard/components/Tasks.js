            ...
            <CardBody className="pt-2 pb-3">
                ...
                <PerfectScrollbar style={{ maxHeight: '376px' }}>
                    <TaskList>
                        ...
                        <TaskItem title='Write a release note for user' due_date="24 Aug, 2019" className="mt-2" />
                        <TaskItem title='Invite Greeva to a project  admin' due_date="22 Aug, 2019" className="mt-2" />
